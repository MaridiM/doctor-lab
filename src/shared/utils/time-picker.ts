...
export function set12Hours(date: Date, value: string, period: TPeriod) {
...
export function setDateByType(date: Date, value: string, type: TTimePickerType, period?: TPeriod) {
    switch (type) {
        case 'minutes':
...
export function getDateByType(date: Date, type: TTimePickerType) {
    switch (type) {
        case 'minutes':
...
export function getArrowByType(value: string, step: number, type: TTimePickerType) {
    switch (type) {
        case 'minutes':
 ...
 * 12:00 AM is 00:00
 */
export function convert12HourTo24Hour(hour: number, period: TPeriod) {
    if (period === 'PM') {
        if (hour <= 11) {
            return hour + 12
        } else {
