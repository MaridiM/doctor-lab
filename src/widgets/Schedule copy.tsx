                                    ...
                                    .map((_, idx) => {
                                        ...
                                        return (
                                            <li
                                                ...
                                                className={cn(
                                                    'transition-color group bg-transparent px-2 py-1 duration-300 ease-in-out border-b-20',
                                                    {
                                            ...
                                            >
                                                {idx > 0 && !lastItem && isHoverTimeSlot === idx && (
                                                    <div
                                                        className='flex w-full items-center justify-center gap-2 rounded-md border-20'
                                                        style={{
                                                            height:
                                                                idx === 0 || lastItem
                                                                    ? heightCell / (60 / timeStep) / 2 - 4
                                                                    : heightCell / (60 / timeStep) - 4
                                                        }}
                                                    >
